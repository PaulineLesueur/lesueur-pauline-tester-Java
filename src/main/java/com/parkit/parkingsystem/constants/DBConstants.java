...
public class DBConstants {
    ...
    public static final String UPDATE_INTIME_TICKET = "update ticket set IN_TIME=? where ID=?";
    ...
    public static final String COUNT_ID = "select count(*) from ticket where VEHICLE_REG_NUMBER=?";
}
